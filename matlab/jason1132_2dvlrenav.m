...
divenumber=1132;
m.orglat=34.91387000;
m.orglon=-75.18433000;
...
launch_ymdhms = [2019 04 21 16 20 00];
survey_start_ymdhms = [2019 04 21 19 13 00];
ascent_start_ymdhms = [2019 04 22 18 53 00];
surface_ymdhms = [2019 04 22 20 08 00];

%% Set paths to the original (raw) data files
npath='/Volumes/JasonRaid1_/RB1903/Vehicle/Procdata/RB1903/J2-1132/navest/';
svel_path='/Volumes/JasonRaid1_/RB1903/Vehicle/Procdata/RB1903/J2-1132/svp/';
...
%% Define upper limit on DVL ping velocity
max_veh_vel = 12.0;
