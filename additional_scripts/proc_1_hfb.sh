...
# -----------------------------------------------------------------------------
# Name: process_1_hfb
# Description: preprocesses hfb data and makes it ready for manual editing
#
# Usage: process_1_hfb  <indir> <lowering>
...
set _D = $PWD
set datatype_suffix = HFB
set datatype_input_subdir = hfp
...
# -----------------------------------------------------------------------------
if ( $#argv != 2 ) then
  echo "Usage: $0 <indir> <lowering> <cruise>"
