...
# -----------------------------------------------------------------------------
# Name: process_1_csv
# Description: preprocesses CSV data and makes it ready for manual editing
#
# Usage: process_1_csv <indir> <lowering>
...
set _D = $PWD
set datatype_suffix = CSV
set datatype_input_subdir = csv
