...
# -----------------------------------------------------------------------------
# Name: process_1_mag
# Description: preprocesses HMR data and makes it ready for manual editing
#
# Usage: process_1_mag <indir> <lowering>
...
set _D = $PWD
set datatype_suffix = HMR
set datatype_input_subdir = mag
...
onintr QUIT_SCRIPT
  ...
  # Custom step for HMR
  mv $outfile $real_outdir/$lowering.MAG.raw
  echo "Results saved to: $real_outdir/$lowering.MAG.raw"
