...
# -----------------------------------------------------------------------------
# Name: process_1_ctm
# Description: preprocesses CTM data and makes it ready for manual editing
#
# Usage: process_1_ctm <indir> <lowering>
...
set _D = $PWD
set datatype_suffix = CTM
set datatype_input_subdir = ctm
