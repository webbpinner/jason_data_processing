...
# -----------------------------------------------------------------------------
# Name: process_1_ctd
# Description: preprocesses CTD #1 data and makes it ready for manual editing
#
# Usage: process_1_ctd <indir> <lowering>
...
set _D = $PWD
set datatype_suffix = CTD
set datatype_input_subdir = ctd
