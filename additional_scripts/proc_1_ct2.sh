...
# -----------------------------------------------------------------------------
# Name: process_1_ct2
# Description: preprocesses CTD #2 data and makes it ready for manual editing
#
# Usage: process_1_ct2 <indir> <lowering>
...
set _D = $PWD
set datatype_suffix = CT2
set datatype_input_subdir = ct2
